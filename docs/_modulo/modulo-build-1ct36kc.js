...
currentModulo.assets.functions["xr8shpn"]= function (CTX, G){
var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
...
currentModulo.assets.functions['ivfolv']('x-page', currentModulo);
