...
// ------------------------------------------------------------------
Modulo.assets.functions["x1f5vg40"]= function (CTX, G){
var OUT=[];
OUT.push("<head>\n    <title>"); // "<head>\n    <title>"
...
`,// (ends: /components/core.html) 
  ...
  "/components/core/Page.html": // (11 lines)
`<head>
...
Modulo.globalLoader.loadString("<library namespace=\"x\" src=\"/components/core.html\"></library>");
